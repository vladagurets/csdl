...
2. place equal concept Nodes.
3. connect them as one Cluster.
4. select the learning Node.
...
- Reading paths: `top_left_to_bottom_right`, `center_out`.
...
- Required bindings: `headline`, `pillars`.
...
- Semantic mechanism: `framework-mechanism`.
