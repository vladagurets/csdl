...
1. define two labeled Axes.
2. create four open regions.
3. place four Nodes.
4. select one Node.
...
- Reading paths: `outside_to_inside`.
...
- Required bindings: `headline`, `axes`, `nodes`.
...
- Semantic mechanism: `matrix-mechanism`.
