...
- `Vector directs Field`.
- `Signal highlights Field`.

## Forbidden relations

- `Divider directs Field` is forbidden because it substitutes another semantic mechanism.

## Assembly order

1. define before Field.
2. define after Field.
3. connect with one Vector.
4. signal changed property.
...
- Dominant signal: `mineral_green`. Color reinforces form or label and never becomes the only carrier of meaning.

## Content contract

- Required bindings: `headline`, `before`, `after`.
...
- Semantic mechanism: `before-after-mechanism`.
