...
- `Field directs Anchor` is forbidden because it substitutes another semantic mechanism.

## Assembly order

1. place short title Anchor.
2. establish one open Field.
3. add one Signal plane.
...
- Semantic mechanism: `cover-mechanism`.
