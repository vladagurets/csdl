...
1. place two opposing Anchors.
2. create one functional overlap.
3. label the result.

## Expression levels

- Level A: `forbidden` — No accepted evidence supports this recipe at the expression level.
- Level B: `allowed`.
- Level C: `allowed`.
...
- Required bindings: `left`, `right`, `result`.
...
- Semantic mechanism: `collision-mechanism`.
