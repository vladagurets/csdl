...
- `Axis orders Label`.
- `Signal highlights Label`.

## Forbidden relations

- `Frame directs Label` is forbidden because it substitutes another semantic mechanism.

## Assembly order

1. place title.
2. align headers and values.
3. use rules only for lookup.
4. signal one column.
...
- Required bindings: `headline`, `columns`, `rows`, `source_label`.
...
- Semantic mechanism: `table-mechanism`.
